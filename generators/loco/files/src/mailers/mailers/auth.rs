...
impl AuthMailer {
    ...
    pub async fn send_welcome(ctx: &AppContext, user: &Model) -> Result<()> {
        Self::mail_template(
            ctx,
            &welcome,
            mailer::Args {
    ...
    ///
    /// When email sending is failed
    pub async fn forgot_password(ctx: &AppContext, user: &Model) -> Result<()> {
        Self::mail_template(
            ctx,
            &forgot,
            mailer::Args {
    ...
    ///
    /// When email sending is failed
    pub async fn send_magic_link(ctx: &AppContext, user: &Model) -> Result<()> {
        Self::mail_template(
            ctx,
            &magic_link,
            mailer::Args {
